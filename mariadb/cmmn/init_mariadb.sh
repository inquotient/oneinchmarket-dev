...
then
    ...
    sudo kubectl delete -f mariadb-configmap.yaml -f mariadb-secret.yaml -f mariadb-headless.yaml -f mariadb-statefulset.yaml -f mariadb-nodeport.yaml -n dev
    ...
    sudo kubectl apply -f mariadb-configmap.yaml -f mariadb-secret.yaml -f mariadb-headless.yaml -f mariadb-statefulset.yaml -f mariadb-nodeport.yaml -n dev
