...
RULES = [
    ...
    (r"^kibana-kb-http$", 5601, "UI", 5601, "**https** · elastic / `pw elasticsearch-es-elastic-user elastic`"),
    ...
    (r"^vault", 8200, "UI", 8200, "토큰 `pw vault-init root-token`"),
    (r"^vault", 8201, "INT", 0, "Raft 클러스터 포트(미사용)"),
    ...
    (r"^elasticsearch-es-http$", 9200, "DB", 19200, "https · elastic / **ECK 시크릿**(수기 것은 401)"),
    (r"^elasticsearch-es-default$", 9200, "INT", 0, "파드 직접"),
    (r"^elasticsearch-es-internal-http$", 9200, "INT", 0, "ECK 내부"),
    (r"^elasticsearch-es-transport$", 9300, "INT", 0, "노드 간"),
